...
<div class="container">
    <div class="container">
        <h3 class="text-center" style="padding-top: 50px !important; font-size: 50px;">My Reports</h3>
        <p class="text-center" style="color:red">An archive of reports produced by this account.</p> @if (count($posts)=== 0) {{-- Nobody's here         --}} @else <div class="card-deck row"> @foreach ($posts as $index => $person) @if ($index % 3 == 0) <div class="row"> @endif <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card mb-4">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('editmyreport',['id' => $person['id']]) }}" method="POST"> @csrf <div class="card-body">
                                                    <div class="row gx-3 mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input class="form-control" id="inputPlaceOfBirth" name="place_of_birth" value="{{$person['place_of_birth']}}" type="text">
                                                        </div>
                                                        <div class="col-md-6">
                            ...
                            <div class="modal fade" id="deletereportmodal{{ $person['id'] }}" tabindex="-1" role="dialog" aria-labelledby="editreportmodalTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <form action="{{{route('deletemyreport',['id' => $person['id']])}}}" method="post"> @csrf <span>Are you sure you want to delete this post?</span>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
